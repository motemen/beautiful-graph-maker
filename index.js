...
var _user$project$Main$queryStringFromModel = function (model) {
	return _Bogdanp$elm_querystring$QueryString$render(
		A3(
...
var _user$project$Main$promptResult = _elm_lang$core$Native_Platform.incomingPort(
	'promptResult',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {yLabelUpper: a, yLabelLower: b, lineRising: c};
	});
var _user$project$Main$modelFromQueryString = function (search) {
	var qs = _Bogdanp$elm_querystring$QueryString$parse(search);
	return A3(
		_user$project$Main$Model,
		A2(
			_elm_lang$core$Maybe$withDefault,
			'😊',
			A3(_Bogdanp$elm_querystring$QueryString$one, _Bogdanp$elm_querystring$QueryString$string, 'y2', qs)),
		A2(
			_elm_lang$core$Maybe$withDefault,
			'🙁',
			A3(_Bogdanp$elm_querystring$QueryString$one, _Bogdanp$elm_querystring$QueryString$string, 'y1', qs)),
		function (a) {
			return !_elm_lang$core$Native_Utils.eq(a, -1);
		}(
			A2(
				_elm_lang$core$Maybe$withDefault,
				1,
				A3(_Bogdanp$elm_querystring$QueryString$one, _Bogdanp$elm_querystring$QueryString$int, 'a', qs))));
};
var _user$project$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$modelFromQueryString(location.search),
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'UrlChange':
				return _user$project$Main$init(_p0._0);
			case 'RequestYLabelUpper':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$prompt('Upper')
				};
			case 'RequestYLabelLower':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$prompt('Lower')
				};
			default:
								...
								if (_p1._0.ctor === '_Tuple2') {
									switch (_p1._0._0) {
										case 'Upper':
											return _elm_lang$core$Native_Utils.update(
												model,
												{yLabelUpper: _p1._0._1});
										case 'Lower':
											return _elm_lang$core$Native_Utils.update(
												model,
												{yLabelLower: _p1._0._1});
										default:
											break _v1_3;
									}
								} else {
				...
				return {
					...
					_1: _elm_lang$navigation$Navigation$modifyUrl(
						_user$project$Main$queryStringFromModel(newModel))
				};
		}
	});
var _user$project$Main$ToggleTrend = {ctor: 'ToggleTrend'};
var _user$project$Main$SetYLabel = function (a) {
	return {ctor: 'SetYLabel', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$promptResult(_user$project$Main$SetYLabel);
};
var _user$project$Main$RequestYLabelLower = {ctor: 'RequestYLabelLower'};
var _user$project$Main$RequestYLabelUpper = {ctor: 'RequestYLabelUpper'};
var _user$project$Main$view = function (model) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$id('canvas'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('-50 0 450 450'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$id('arrow-head'),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$text_,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$dx('-50'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$style('font-size: 50px'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$textLength('100'),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Main$RequestYLabelUpper),
													_1: {ctor: '[]'}
												}
											}
										}
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text(model.yLabelUpper),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Main$RequestYLabelLower),
														_1: {ctor: '[]'}
													}
												}
											}
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg$text(model.yLabelLower),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$style('font-family: \'Helvetica Neue\', sans-serif; font-size: 24px'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$svg$Svg$text_,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$dy('40'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
												_1: {
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg$text('Before'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$dx('10'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$dy('40'),
												_1: {
										...
										{
											ctor: '::',
											_0: _elm_lang$svg$Svg$text('After'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$id('line-up'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$markerEnd('url(#arrow-head)'),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$display(
														model.lineRising ? '' : 'none'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Main$ToggleTrend),
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$x1('100'),
															_1: {
																ctor: '::',
																_0: _elm_lang$svg$Svg_Attributes$x2('300'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$svg$Svg_Attributes$y1('300'),
																	_1: {
																		ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$id('line-down'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$markerEnd('url(#arrow-head)'),
											_1: {
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$svg$Svg_Attributes$y2('300'),
																			_1: {ctor: '[]'}
																		}
																	}
																}
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$y1('350'),
															_1: {
																ctor: '::',
											...
											_elm_lang$svg$Svg$line,
											{
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$x2('350'),
															_1: {
																ctor: '::',
																_0: _elm_lang$svg$Svg_Attributes$y1('350'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$svg$Svg_Attributes$y2('350'),
																	_1: {ctor: '[]'}
																}
															}
														}
